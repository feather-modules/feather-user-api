...
extension User.Oauth {
    ...
    enum Schemas {
        ...
        enum CodeChallenge: TextSchema {
            static let description =
                "the code challenge generated by the client application"
            static let examples = [
                "sddfslkdnflasndf"
            ]
        }
        ...
        enum CodeVerifier: TextSchema {
            static let description =
                "a plaintext string that was used to calculate the hash that was previously sent in the code_challenge parameter"
            static let examples = [
                "uiu9879khh"
            ]
        }
